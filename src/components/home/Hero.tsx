    ...
    <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-secondary">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-4 justify-center">
          <button className="bg-primary hover:bg-amber-600 text-secondary font-bold py-4 px-8 rounded-full transition-all transform hover:scale-105 uppercase cursor-pointer">
            Daftar Sekarang
          </button>
